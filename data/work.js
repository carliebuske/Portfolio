...
const WORK = [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        h: "My role",
        p: "Experiential producer on the show — production, talent and segment coordination, partner wrangling, and on-the-day operations across the live-to-tape build.",
      },
    ],
    results: [
