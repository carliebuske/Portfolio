...
const WORK = [
  ...
  },
  {
    ...
    tone: "olive",
    poster: "assets/whitelotus/title-card.jpg",
  ...
  },
  {
    ...
    sections: [
      ...
      {
        h: "My role",
        p: "Creative & Innovation Director across both pieces — from ideation to delivery. I concepted and directed the talent and segments, briefed and partnered with NBCUniversal and Team USA, and worked with production through pre-pro, on set, and post on the broadcast and social cutdowns.",
      },
    ],
  ...
  },
  {
    ...
    type: "work",
    tier: 2,
    title: "Can You GIFT It? × Google Shopping",
    ...
    categories: ["social", "ctv"],
    tone: "almond",
    poster: "assets/gameshow/shopping-mood7.png",
