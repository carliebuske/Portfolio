...
const WORK = [
  ...
  },
  {
    ...
    type: "work",
    tier: 1,
    title: "One Day in Paris with GGL + Team USA",
  ...
  },
  {
    ...
    story:
      "Electric Cowboy — a partner summit built around swagger, community, and the art of hosting. Produced from concept to live execution, blending experiential design with brand storytelling to celebrate VRBO's rental partners.",
    sections: [
      {
        h: "The event",
        p: "VRBO Partner Summit: Electric Cowboy edition. A full-day activation celebrating the partners who power VRBO — built with an unmissable visual identity and a rhythm that kept energy high from start to finish.",
      },
      {
        h: "My role",
        p: "Producer + Creative Direction. I handled the full event from concept through execution — building the visual language, overseeing design and production, and directing the experience to create a memorable moment for partners.",
      },
    ],
    result: "Full-scale partner summit · brand experience",
  },
  {
    id: "salesforce",
    type: "work",
